...
export default function ReportDetailPage() {
  ...
  const displayScreenshots = report.evidenceResolved?.screenshots || report.evidence?.screenshots || []
  const displayDocuments = report.evidenceResolved?.documents || report.evidence?.documents || []
